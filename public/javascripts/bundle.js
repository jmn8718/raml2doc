...
/***/ function(module, exports, __webpack_require__) {
	...
	var routes = React.createElement(
	    ...
	    React.createElement(Route, { name: 'docFactory', path: 'docFactory', handler: docFactory }),
	    React.createElement(Route, { name: 'error_status', path: 'error_status', handler: errorStatus }),
	    React.createElement(NotFoundRoute, { handler: notFound404 })
	);
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            Link,
	                            { to: '/docFactory', className: 'mdl-navigation__link' },
	                            'docFactory'
	                        ),
	                        React.createElement(
	                            Link,
	                            { to: '/error_status', className: 'mdl-navigation__link' },
	                            'Errors'
	                        )
	                    )
	                )
